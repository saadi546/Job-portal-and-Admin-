...
<body>
        ...
        <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto p-4 p-lg-0">
                    ...
                    <a href="{{route('jobs.index')}}" class="nav-item nav-link active">Job Listing</a>   --}}
        ...
        <div class="container-fluid p-0">
            <div class="owl-carousel header-carousel position-relative">
                <div class="owl-carousel-item position-relative">
                    <img class="img-fluid" src="{{asset('imgg/carousel-1.jpg')}}" alt="">
                ...
                <div class="owl-carousel-item position-relative">
                    <img class="img-fluid" src="{{asset('imgg/carousel-2.jpg')}}" alt="">
                    <div class="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center" style="background: rgba(43, 57, 64, .5);">
                        <div class="container">
                            <div class="row justify-content-start">
                                <div class="col-10 col-lg-8">
                    ...
                    <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                        <div class="row g-0 about-bg rounded overflow-hidden">
                            <div class="col-6 text-start">
                                <img class="img-fluid w-100" src="{{asset('imgg/about-1.jpg')}}">
                            </div>
                            <div class="col-6 text-start">
                                <img class="img-fluid" src="{{asset('imgg/about-2.jpg')}}" style="width: 85%; margin-top: 15%;">
                            </div>
                            <div class="col-6 text-end">
                                <img class="img-fluid" src="{{asset('imgg/about-3.jpg')}}" style="width: 85%;">
                            </div>
                            <div class="col-6 text-end">
                                <img class="imgg-fluid w-100" src="{{asset('imgg/about-4.jpg')}}">
                            </div>
                        </div>
                    </div>
                ...
                <div class="tab-class text-center wow fadeInUp" data-wow-delay="0.3s">
                    ...
                    <div class="tab-content">
                        ...
                        <div id="tab-2" class="tab-pane fade p-0">
                            @foreach ($fulltime_jobs as $job)
                            @if ($job->job_nature === 'full_time')
                                <div class="job-item p-4 mb-4">
                                    <!-- Your job item HTML for Featured jobs goes here -->
                                    <div class="row g-4">
                                        <div class="col-sm-12 col-md-8 d-flex align-items-center">
                ...
                <div class="owl-carousel testimonial-carousel">
                    <div class="testimonial-item bg-light rounded p-4">
                        ...
                        <div class="d-flex align-items-center">
                            <img class="img-fluid flex-shrink-0 rounded" src="{{asset('imgg/testimonial-1.jpg')}}" style="width: 50px; height: 50px;">
                            <div class="ps-3">
                    ...
                    <div class="testimonial-item bg-light rounded p-4">
                        ...
                        <p>Dolor et eos labore, stet justo sed est sed. Diam sed sed dolor stet amet eirmod eos labore diam</p>
                        <div class="d-flex align-items-center">
                            <img class="img-fluid flex-shrink-0 rounded" src="{{asset('imgg/testimonial-2.jpg')}}" style="width: 50px; height: 50px;">
                            <div class="ps-3">
                                <h5 class="mb-1">Client Name</h5>
                                <small>Profession</small>
                            </div>
                    ...
                    <div class="testimonial-item bg-light rounded p-4">
                        ...
                        <p>Dolor et eos labore, stet justo sed est sed. Diam sed sed dolor stet amet eirmod eos labore diam</p>
                        <div class="d-flex align-items-center">
                            <img class="img-fluid flex-shrink-0 rounded" src="{{asset('imgg/testimonial-3.jpg')}}" style="width: 50px; height: 50px;">
                            <div class="ps-3">
                                <h5 class="mb-1">Client Name</h5>
                                <small>Profession</small>
                            </div>
                    ...
                    <div class="testimonial-item bg-light rounded p-4">
                        ...
                        <p>Dolor et eos labore, stet justo sed est sed. Diam sed sed dolor stet amet eirmod eos labore diam</p>
                        <div class="d-flex align-items-center">
                            <img class="img-fluid flex-shrink-0 rounded" src="{{asset('imgg/testimonial-4.jpg')}}" style="width: 50px; height: 50px;">
                            <div class="ps-3">
                                <h5 class="mb-1">Client Name</h5>
                                <small>Profession</small>
                            </div>
                ...
                <div class="copyright">
                    <div class="row">
                        <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
							...
							Designed By <a class="border-bottom" href="https://www.brantum.com/">Brantum Technologies</a>
    ...
    <script>
        $(document).ready(function () {
            // Handle navigation links click event
            $('.nav-link').click(function (e) {
                e.preventDefault(); // Prevent the default behavior of the link
        
                // Get the target route URL from the data-route attribute
                var targetRoute = $(this).data('route');
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        // Optionally, you can update the browser's URL
                        // to match the clicked link using the History API
            ...
            // Handle back/forward browser navigation using the History API
            $(window).on('popstate', function () {
                // Get the current URL and load the content via AJAX
