        ...
        <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto p-4 p-lg-0">
                    ...
                    {{-- <a href="{{route('jobs.detail')}}" class="nav-item nav-link active">Job details</a>      --}}
                </div>
                ...
                <div class="row gy-5 gx-4">
                            ...
                            <div class="">
                                ...
                                <form action="{{ route('applications.store') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-12 col-sm-6">
                                            <input type="text" class="form-control" name="portfolio_link" placeholder="Portfolio Website" required>
                                        </div>
                                        <div class="col-12 col-sm-6">
                                            <input type="file" class="form-control bg-white" name="resume" required>
                                        </div>
                                        <div class="col-12">
                        ...
                        <div class="col-lg-4">
                            <div class="bg-light rounded p-5 mb-4 wow slideInUp" data-wow-delay="0.1s">
                                ...
                                <p><i class="fa fa-angle-right text-primary me-2"></i>Published On: {{ $job->published_date }}</p>
